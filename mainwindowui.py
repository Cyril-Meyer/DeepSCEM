...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/outline_playlist_add_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_dataset_load.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/outline_playlist_remove_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_dataset_unload.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/outline_add_photo_alternate_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_sample_add.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/outline_delete_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_sample_remove.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/outline_save_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_dataset_saveas.setIcon(icon4)
        ...
        self.treeWidge_dataset = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidge_dataset.setObjectName("treeWidge_dataset")
        self.verticalLayout.addWidget(self.treeWidge_dataset)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/outline_add_black_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_model_add.setIcon(icon5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidge_dataset.headerItem().setText(0, _translate("MainWindow", "Dataset"))
